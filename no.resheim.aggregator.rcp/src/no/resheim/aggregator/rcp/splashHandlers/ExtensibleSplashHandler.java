package no.resheim.aggregator.rcp.splashHandlers;
...
public class ExtensibleSplashHandler extends AbstractSplashHandler {
	...
	private final static String F_SPLASH_EXTENSION_ID = "no.resheim.aggregator.rcp.splashExtension"; //NON-NLS-1 //$NON-NLS-1$

	private final static String F_ELEMENT_ICON = "icon"; //NON-NLS-1 //$NON-NLS-1$

	private final static String F_ELEMENT_TOOLTIP = "tooltip"; //NON-NLS-1 //$NON-NLS-1$

	private final static String F_DEFAULT_TOOLTIP = "Image"; //NON-NLS-1 //$NON-NLS-1$
	...
	private void configureUICompositeIconPanelBounds() {
		...
		int x_coord = getSplash().getSize().x - F_SPLASH_SCREEN_BEVEL
				- panelSize.x;
		int y_coord = getSplash().getSize().y - F_SPLASH_SCREEN_BEVEL
				- panelSize.y;
